...
#ifndef MULTIPING_SWIFT_H
#define MULTIPING_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MultiPing",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
SWIFT_PROTOCOL("_TtP9MultiPing13ModeSwitching_")
@protocol ModeSwitching
- (void)switchModeTo:(NSString * _Nonnull)newMode;
@end

@class NSNotification;
@class NSApplication;
SWIFT_CLASS("_TtC9MultiPing11AppDelegate")
@interface AppDelegate : NSObject <NSApplicationDelegate, ModeSwitching>
...
@interface AppDelegate (SWIFT_EXTENSION(MultiPing)) <NSWindowDelegate>
@end

@class NSWindow;
@class NSCoder;
SWIFT_CLASS("_TtC9MultiPing27FindDevicesWindowController")
@interface FindDevicesWindowController : NSWindowController
...
@interface FindDevicesWindowController (SWIFT_EXTENSION(MultiPing)) <NSWindowDelegate>
- (void)windowWillClose:(NSNotification * _Nonnull)notification;
@end

SWIFT_CLASS("_TtC9MultiPing17MainWindowManager")
@interface MainWindowManager : NSObject <NSWindowDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)windowWillClose:(NSNotification * _Nonnull)notification;
...
@class NSMenuItem;
SWIFT_CLASS("_TtC9MultiPing17MenuBarController")
@interface MenuBarController : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)showDevices;
- (void)showFindDevicesWindow;
- (void)toggleFloatingWindow;
- (void)setOpacity:(NSMenuItem * _Nonnull)sender;
- (void)quitApp;
- (void)sendFeatureRequest;
@end

SWIFT_CLASS("_TtC9MultiPing28ModeSelectorWindowController")
@interface ModeSelectorWindowController : NSWindowController
...
SWIFT_CLASS("_TtC9MultiPing18NonActivatingPanel")
...
SWIFT_CLASS("_TtC9MultiPing14WindowDelegate")
